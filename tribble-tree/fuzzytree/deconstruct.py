...
Classification is out of scope here: generalizing the affine branch combiner
to class-probability stacking is a separate design question.
"""
...
from tribblefis.gauss_data import GaussianMixtureModel, resolve_norm_pair
...
from .hme import _ConstantRegressor
