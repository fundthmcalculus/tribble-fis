...
| **A4** | **Fuzzy tokenizer + linguistic parameter space** — hybrid vocabulary (547 nameable units), graded segmentation, 66 named UD/shape/semantic/affect dims | built & component-tested; **not yet wired into the LM**, so no perplexity number | [`fuzzytok/`](fuzzytok/) |
