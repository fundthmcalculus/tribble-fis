...
def main():
    ...
    print("- Trapezoid MFs: Broader regions, better for plateau-like distributions")
    print("- For Darwin (complex handwriting), Gaussian likely superior")
    print("- Trapezoids offer trade-off: interpretability vs. accuracy")
    print("=" * 80)
